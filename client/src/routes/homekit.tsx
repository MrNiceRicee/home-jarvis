    ...
    <div>
      ...
      {config ? (
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 text-center">
            {config.paired ? (
              <>
                ...
                <p className="text-sm text-gray-500 mt-1">Your Home Jarvis bridge is connected to Apple Home.</p>
              ...
              <>
                ...
                <p className="text-xs text-gray-400 mt-2">Open Apple Home → + → Add Accessory → enter PIN above</p>
              </>
            )}
          </div>
        ...
        <div className="max-w-sm bg-white rounded-xl border border-gray-200 p-6 text-center">
          ...
          <p className="text-sm text-gray-500 mt-1 mb-4">The HAP bridge will be configured in Phase 5.</p>
          <Button
            isDisabled
