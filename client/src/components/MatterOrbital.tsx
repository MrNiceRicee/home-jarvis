	...
	return (
		...
		<div style={{ width: size }} className="aspect-square">
			...
			>
				...
				<MetadataLabel x={center} y={center - ringRadius * 1.3} label="PORT" value={port || '—'} />
				<MetadataLabel x={center + ringRadius * 1.2} y={center + ringRadius * 0.6} label="PAIRED" value={paired ? 'YES' : 'NO'} />
				<MetadataLabel x={center - ringRadius * 1.2} y={center + ringRadius * 0.6} label="UPTIME" value={uptimeDisplay} />
